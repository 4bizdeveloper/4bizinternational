...
// Ultra-optimized SEO Meta Tags (Resolved layout imaging & configuration conflicts)
export const metadata: Metadata = {
  title: 'Digital Transformation & Emerging Technologies | 4Biz International',
  description: "Transform traditional operations into intelligent, data-driven digital enterprises through AI, automation, cloud technologies, and innovation-led strategies tailored to your business goals.",
  alternates: {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/4biz_logo-1.png", // Explicitly passed to prevent override deletion
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: 'Digital Transformation & Emerging Technologies | 4Biz International',
    description: "Transform traditional operations into intelligent, data-driven digital enterprises through AI, automation, cloud technologies, and innovation-led strategies tailored to your business goals.",
    images: ["/4biz_logo-1.png"], // Explicitly passed to prevent override deletion
  },
};
