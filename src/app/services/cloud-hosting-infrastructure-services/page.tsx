...
export default function InfrastructureServicesPage() {
  ...
  const serviceSchema = {
    ...
    'hasOfferCatalog': {
      ...
      'itemListElement': [
        ...
        { '@type': 'Offer', 'itemOffered': { '@type': 'Service', 'name': 'Shared & VPS Hosting' } },
        { '@type': 'Offer', 'itemOffered': { '@type': 'Service', 'name': 'AWS & Azure Cloud Solutions' } },
  ...
  return (
    <div className="min-h-screen text-slate-100 selection:bg-blue-600 selection:text-white overflow-x-hidden antialiased scroll-smooth relative bg-[#040a21]">
      ...
      {/* ================= CLEAN BACKGROUND (CURVES AND LINES REMOVED) ================= */}
      ...
      <div className="relative z-10">
        ...
        {/* ================= CENTERED BREADCRUMB LIST ================= */}
        <nav 
          aria-label="Breadcrumb"
          className="pt-28 md:pt-36 pb-4 px-4 sm:px-6 lg:px-8 flex justify-center items-center text-center"
        >
          <ol className="inline-flex items-center flex-wrap justify-center gap-1 sm:gap-2 text-xs sm:text-sm text-slate-400 bg-white/[0.03] border border-slate-800/80 rounded-full px-4 sm:px-6 py-2 backdrop-blur-md shadow-lg">
            <li>
              <Link 
            ...
            <li className="text-slate-600 select-none">&gt;</li>
            <li>
              <Link 
            ...
            <li className="text-slate-600 select-none">&gt;</li>
            <li className="text-teal-300 font-semibold truncate max-w-[200px] sm:max-w-xs md:max-w-none" aria-current="page">
        ...
        <section className="relative min-h-[70vh] flex flex-col justify-center pt-6 pb-16 px-4 sm:px-6 lg:px-8 bg-transparent">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-white/[0.03] border border-slate-800/60 backdrop-blur-xl transition-all duration-300 hover:border-teal-500/40 hover:-translate-y-1 group">
                ...
                <p className="text-sm text-slate-400 leading-relaxed">
                  Moving existing servers, databases, and applications to the cloud with a planned cutover and validated data integrity.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="p-6 rounded-xl bg-white/[0.015] border border-slate-800/40 backdrop-blur-sm pt-[18px] border-t-2 border-t-teal-400">
                <h3 className="text-white font-bold text-base mb-2">Right-sized infrastructure</h3>
              ...
              <div className="p-6 rounded-xl bg-white/[0.015] border border-slate-800/40 backdrop-blur-sm pt-[18px] border-t-2 border-t-teal-400">
                <h3 className="text-white font-bold text-base mb-2">Proactive monitoring</h3>
              ...
              <div className="p-6 rounded-xl bg-white/[0.015] border border-slate-800/40 backdrop-blur-sm pt-[18px] border-t-2 border-t-teal-400">
                <h3 className="text-white font-bold text-base mb-2">Tested recovery plans</h3>
